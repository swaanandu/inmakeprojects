...
<body>
  <div class="hero">
    <nav>
      <img src="images/logw.png" class="logo">
      <ul>
        <li><a href="#">Home</a></li>
...
<div class="about-section">
  <div class="inner-container">
    <h1>About Us</h1>
    <p class="text">
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore officia ab explicabo odit dicta, iste id minima eaque! Repellat temporibus aliquam totam ullam esse minus laborum aliquid consequuntur voluptate saepe?
</p>
...
<html lang="en">
  <head>
    ...
    <title>Web Design Mastery | Wanderlust</title>
  </head>
  <body>
    <header class="header">
      <nav>
        <div class="nav__logo"><a href="#">Wanderlust</a></div>
        <ul class="nav__links">
    ...
    <section class="section__container trending__container" id="trending">
      ...
      <div class="trending__grid">
        <div class="trending__card">
          <img src="assets/trending-1.jpg" alt="trending" />
        ...
        <div class="trending__card">
          <img src="assets/trending-2.jpg" alt="trending" />
          <h1>Train Tour Skyline</h1>
        ...
        <div class="trending__card">
          <img src="assets/trending-3.jpg" alt="trending" />
          <h1>Wild Forest Life</h1>
    ...
    <section class="section__container destination__container" id="destination">
      ...
      <div class="destination__grid">
        ...
        <div class="destination__card">
          <img src="assets/destination-5.jpg" alt="destination" />
        ...
        <div class="destination__card">
          <img src="assets/destination-6.jpg" alt="destination" />
          <div class="badge">4.7</div>
          <div class="destination__details">
            <h4>Amsterdam</h4>
            <p>Peace</p>
      ...
      <div class="seller__grid">
        <div class="seller__card">
          <div class="seller__image">
            <img src="assets/seller-1.jpg" alt="seller" />
          ...
          <div class="seller__details">
            <h4>Trains Tour Skyline</h4>
            <p>Embark on a scenic railway adventure with Trains Tour Skyline</p>
          </div>
        </div>
        <div class="seller__card">
          <div class="seller__image">
            <img src="assets/seller-2.jpg" alt="seller" />
            <div class="seller__image__content">
        ...
        <div class="seller__card">
          <div class="seller__image">
            <img src="assets/seller-3.jpg" alt="seller" />
            <div class="seller__image__content">
          ...
          <div class="seller__details">
            <h4>Tokyo Market Ptr</h4>
            <p>Where Tradition Meets Modern Marvels in Every Aisle</p>
          </div>
        </div>
      </div>
    </section>
